...
namespace OnlineShop.Application.Implementations.Commands.Users;
    ...
    public class RegisterCommandHandler : IRequestHandler<RegisterCommand, Result>
    {
        ...
        public Task<Result> Handle(RegisterCommand request, CancellationToken cancellationToken)
            => DoesUserNotExists(request,cancellationToken)
                                ...
                                .AndAsync(_ => _writerRepository.AddAsync(request.Data.MapToPorts(), cancellationToken))
                                .AndAsync(_ => _writerRepository.SaveAsync(request.Data.MapToPorts(), cancellationToken))
                                .RemoveDataAsync();
